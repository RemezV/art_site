...
/* harmony import */ var _modules_validateText__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/validateText */ "./src/js/modules/validateText.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_validateText__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_validateText__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_moreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
...
var calculator = function calculator(size, material, options, promocode, result) {
  ...
  function calc() {
    ...
    if (!sizeBlock.value || !materialBlock.value) {
      resultBlock.textContent = 'Для рассчета стоимости нужно больше данных';
...
var forms = function forms() {
  ...
  upload.forEach(function (input) {
    input.addEventListener('input', function () {
      var dots;
      var splitedName = input.files[0].name.split('.');
      splitedName[0].length > 6 ? dots = '...' : dots = '.';
      var name = splitedName[0].slice(0, 5) + dots + splitedName[1];
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    var val = this.value.replace(/\D/g, ''); // Устраняем возможность удаления +7
    ...
    this.value = matrix.replace(/./g, function (c) {
      return /[_\d]/.test(c) && i < val.length ? val.charAt(i++) : i >= val.length ? '' : c;
    });
...
var modals = function modals() {
  ...
  openByScroll('.fixed-gift'); // showModal('.popup-consultation', 60000);
};
...
var moreStyles = function moreStyles(trigger, wrapper) {
...
var validateText = function validateText(selector) {
  var textInputs = document.querySelectorAll(selector);
  textInputs.forEach(function (input) {
    input.addEventListener('keypress', function (e) {
      if (e.key.match(/[^а-яё0-9]/gi)) {
        e.preventDefault();
      }
    });
  });
...
/* harmony default export */ __webpack_exports__["default"] = (validateText);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not get data from ".concat(url));
